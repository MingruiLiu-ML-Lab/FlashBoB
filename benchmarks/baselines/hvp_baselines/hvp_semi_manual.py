...
Triton implementation of FlashAttention-style kernels with Jacobian-vector
product (JVP) and Hessian-vector product (HVP) support.
...
* Flash JVP formulation: https://arxiv.org/abs/2410.11081
"""
...
def _attn_fwd_inner(
    ...
    # Advancing by (0, lo) can trigger an illegal memory access in fp8 mode.
    ...
    for start_n in range(lo, hi, BLOCK_N):
        ...
        # NOTE: This follows the fp8 K/V advancement used by the baseline kernel.
